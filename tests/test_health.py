...
from services.bookings_service.routers.bookings import health_check as bookings_health
...
from services.users_service.routers.users import health_check as users_health
